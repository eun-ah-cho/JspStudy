...
<body>
	...
	<div class="container py-4">
		...
		<%
			...
			BookRepository dao = BookRepository.getInstance(); //세선처리 불가로 바로 임포트 
			
			Book book = dao.getBookById(id); // dao에 다녀와서 객체를 리턴
			
			System.out.println(book);//객체 정상 처리 인지 테스트 
		...
		%>
		 ...
		 <div class="col-md-5">
		 <!-- 교재 이미지용 박스 -->
		 <img src="./resources/images/<%=book.getFilename() %>"  style="width : 70%"> </div>
